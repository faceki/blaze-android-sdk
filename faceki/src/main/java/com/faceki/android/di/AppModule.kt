...
import com.faceki.android.data.repository.WorkflowRuleRepositoryImpl
...
internal object AppModule {
    ...
    @Volatile
    private var workflowRuleRepository: WorkflowRuleRepository? = null
    ...
    fun provideWorkflowRuleRepository(
        faceKiApi: FaceKiApi = provideFaceKiApi(), preferences: Preferences = providePreferences()
    ): WorkflowRuleRepository {
        return workflowRuleRepository ?: synchronized(this) {
            workflowRuleRepository ?: run {
                WorkflowRuleRepositoryImpl(
                    faceKiApi = faceKiApi, preferences = preferences
                ).also {
                    workflowRuleRepository = it
                }
            }
        }
    }
